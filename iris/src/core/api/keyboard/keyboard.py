...
from iris.src.core.api.keyboard.key import Key, KeyModifier
from iris.src.core.api.keyboard.keyboard_util import (
...
class _Keyboard:
    ...
    def type(text: Key or str = None, modifier=None, interval: int = None):
        ...
        if modifier is None:
            ...
            from iris.src.core.api.keyboard.keyboard_util import get_active_modifiers
