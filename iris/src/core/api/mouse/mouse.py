...
from iris.src.core.api.enums import Alignment
from iris.src.core.api.errors import FindError
from iris.src.core.api.finder.image_search import image_find
from iris.src.core.api.finder.pattern import Pattern
from iris.src.core.api.finder.text_search import text_find
from iris.src.core.api.location import Location
from iris.src.core.api.mouse.mouse_controller import Mouse
from iris.src.core.api.rectangle import Rectangle

try:
    from iris.src.core.api.mouse.mouse_controller import Button
except AttributeError:
    from iris.src.core.api.enums import Button
...
def drag_drop(
    ...
    if isinstance(drag_from, Location):
        ...
        raise ValueError(
            f"drag_from argument must be Location or Pattern or str, {type(drag_from)}"
        )
    ...
    if isinstance(drop_to, Pattern):
        ...
        raise ValueError(
            f"drop_to argument must be Location or Pattern or str, {type(drop_to)}"
        )
