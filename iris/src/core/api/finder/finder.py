...
from iris.src.core.api.enums import Color
from iris.src.core.api.enums import MatchTemplateType
from iris.src.core.api.errors import FindError
from iris.src.core.api.finder.image_search import (
    image_find,
    match_template,
    image_vanish,
)
from iris.src.core.api.finder.pattern import Pattern
from iris.src.core.api.finder.text_search import text_find, text_find_all
from iris.src.core.api.highlight.screen_highlight import (
    ScreenHighlight,
    HighlightRectangle,
)
...
from iris.src.core.util.arg_parser import get_core_args
